"""
Stage 3: behaviour under EVIOCGRAB quarantine, and the payload
reconstruction that runs on what was captured.

Merged from: test_behaviour.py, test_payload.py
"""
